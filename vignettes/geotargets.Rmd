...
In this vignette we will demonstrate the use of the `terra` R package, and we will demonstrate how to build raster (`rast`), vector (`vect`), raster collections (`sprc`), and raster datasets (`sds`):
